...
class BaseAgent:
    ...
    def __init__(self, env, test_env, log_dir, num_steps=5 * (10 ** 7),
                 ...
                 max_episode_steps=27000, grad_cliping=5.0, cuda=True, seed=0, exploration=False):
...
#         print(self.exploration)
        ...
        #       f'learning_step: {self.learning_steps:<10}'
        #       f'step: {self.steps:<10}'
        #       f'frame: {self.steps * 4:<10}')
