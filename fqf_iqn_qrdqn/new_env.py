...
class WarpFrame(gym.ObservationWrapper[np.ndarray, int, np.ndarray]):
    ...
    def observation(self, frame: np.ndarray) -> np.ndarray:
        ...
        return frame[:, :, None]
# classstable_baselines3.common.atari_wrappers.AtariWrapper(env, noop_max=30, frame_skip=4, screen_size=84, terminal_on_life_loss=True, clip_reward=True, action_repeat_probability=0.0)
